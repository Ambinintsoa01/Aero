...
<head>
    ...
    <title>Ajouter Employé - Compagnie Aérienne</title>
    <style>
        ...
        <div class="card">
            <form method="POST" action="${pageContext.request.contextPath}/employes">
                ...
                <div class="form-group">
                    ...
                    <select name="role" required>
                        ...
                        <c:forEach var="role" items="${roles}">
                            <option value="${role.role_id}">${role.role_nom}</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="specialisation" placeholder="ex: Commandant de bord">
                </div>
