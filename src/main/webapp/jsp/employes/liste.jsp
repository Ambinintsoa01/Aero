...
<head>
    ...
    <title>Employés - Compagnie Aérienne</title>
    <style>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="${pageContext.request.contextPath}/employes" class="active">
                <span class="icon">👥</span>
                <span>Employés</span>
            </a>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="${pageContext.request.contextPath}/employes/nouveau" class="btn btn-primary">
                        <span>➕</span>
                        Ajouter un employé
                    </a>
                </div>
                ...
                <form method="GET" class="filters">
                    <div class="filter-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prenom" name="prenom" value="${prenom}" placeholder="Rechercher par prénom">
                        </div>
                        <div class="form-group">
                            ...
                            <select id="role" name="role">
                                ...
                                <c:forEach var="role" items="${roles}">
                                    <option value="${role.role_nom}" ${roleFilter == role.role_nom ? 'selected' : ''}>${role.role_nom}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="specialisation">Spécialisation</label>
                            <input type="text" id="specialisation" name="specialisation" value="${specialisation}" placeholder="Ex: Boeing 737">
                        </div>
                    </div>
                    <div class="filter-actions">
                        <button type="submit" class="btn btn-primary">Filtrer</button>
                        <a href="${pageContext.request.contextPath}/employes" class="btn btn-secondary">Réinitialiser</a>
                    </div>
                </form>
                        ...
                        <tbody>
                            <c:forEach var="emp" items="${employes}">
                                <tr>
                                    ...
                                    <td>
                                        <c:forEach var="role" items="${roles}">
                                            <c:if test="${role.role_id == emp.role}">
                                                <span class="badge badge-primary">${role.role_nom}</span>
                                            </c:if>
                                        </c:forEach>
                                    </td>
                                    <td>${emp.specialisation}</td>
                                    <td><strong>${emp.heures_vol_mois}h</strong></td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/employes/planning/${emp.employe_id}" class="btn btn-info btn-sm">
                                            <span>📋</span>
                                            Planning
                                        </a>
                                    </td>
