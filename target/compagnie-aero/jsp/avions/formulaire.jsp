...
<head>
    ...
    <title>Ajouter Avion - Compagnie Aérienne</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="card">
                <h2 class="card-title">Informations de l'avion</h2>
                <p class="card-subtitle">Remplissez tous les champs pour ajouter un nouvel avion à la flotte</p>
                
                <form method="POST" action="${pageContext.request.contextPath}/avions">
                    <input type="hidden" name="action" value="ajouter">

                    <div class="form-group">
                        <label class="form-label">Immatriculation</label>
                        <input type="text" name="immatriculation" class="form-control" required placeholder="Ex: F-HPJA">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Modèle</label>
                        <input type="text" name="modele" class="form-control" required placeholder="Ex: Airbus A320">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Capacité Économique</label>
                        <input type="number" name="capacite_eco" class="form-control" min="0" required placeholder="150">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Capacité Business</label>
                        <input type="number" name="capacite_business" class="form-control" min="0" required placeholder="30">
                    </div>
