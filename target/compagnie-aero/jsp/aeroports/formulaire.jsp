...
<head>
    ...
    <title>Ajouter Aéroport - Compagnie Aérienne</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                ...
                <div class="breadcrumb">
                    ...
                    <a href="${pageContext.request.contextPath}/aeroports">Aéroports</a>
                    <span class="separator">/</span>
                    <span>Nouveau</span>
                </div>
            </div>
        ...
        <div class="container">
            <div class="card">
                <h2 class="card-title">Informations de l'aéroport</h2>
                <p class="card-subtitle">Remplissez tous les champs pour ajouter un nouvel aéroport</p>
                
                <form method="POST" action="${pageContext.request.contextPath}/aeroports">
                    <input type="hidden" name="action" value="ajouter">
                    
                    <div class="form-group">
                        <label class="form-label">Code IATA</label>
                        <input type="text" name="code_iata" class="form-control" required maxlength="3" placeholder="Ex: CDG">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Nom de l'aéroport</label>
                        <input type="text" name="nom" class="form-control" required placeholder="Ex: Aéroport Charles de Gaulle">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Ville</label>
                        <input type="text" name="ville" class="form-control" required placeholder="Ex: Paris">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Pays</label>
                        <input type="text" name="pays" class="form-control" required placeholder="Ex: France">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Fuseau Horaire</label>
                        <input type="text" name="fuseau_horaire" class="form-control" placeholder="Ex: Europe/Paris" required>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <a href="${pageContext.request.contextPath}/aeroports" class="btn btn-secondary">
                            <span>✕</span>
                            Annuler
                        </a>
                    </div>
