...
<head>
    ...
    <title>Créer Vol - Compagnie Aérienne</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <form method="POST" action="${pageContext.request.contextPath}/vols">
                <input type="hidden" name="action" value="ajouter_vol">
                
                <div class="form-group">
                    <label>Numéro Vol</label>
                    <input type="text" name="numero_vol" placeholder="ex: AF006" required>
                </div>

                <div class="form-group">
                    <label>Description</label>
                    <textarea name="description" placeholder="Description du vol..."></textarea>
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">Créer</button>
                    <a href="${pageContext.request.contextPath}/vols" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
