...
<head>
    ...
    <title>Planning Employé - Compagnie Aérienne</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                <h1>Planning de ${employe.prenom} ${employe.nom}</h1>
                <p class="breadcrumb">
                    <a href="${pageContext.request.contextPath}/">Accueil</a> / 
                    <a href="${pageContext.request.contextPath}/employes">Employés</a> / 
                    Planning
                </p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="info-group">
                ...
                <p>${employe.specialisation}</p>
            </div>

            <div class="info-group">
                <span class="info-label">Heures Vol ce Mois:</span>
                <p>${heuresMois}h / ${employe.heures_vol_mois}h</p>
                <c:if test="${heuresMois >= employe.heures_vol_mois}">
                    <div class="badge badge-warning" style="margin-top: 10px;">⚠️ Quota mensuel atteint!</div>
                </c:if>
            </div>

            <h3 style="margin-top: 30px; margin-bottom: 15px;">Vols Assignés</h3>
            <c:choose>
                <c:when test="${empty planning}">
                    <p>Aucun vol assigné.</p>
                </c:when>
                <c:otherwise>
                    <c:forEach var="flight" items="${planning}">
            ...
            <div style="margin-top: 20px;">
                <a href="${pageContext.request.contextPath}/employes" class="btn btn-secondary">Retour</a>
            </div>
        </div>
    </div>
</body>
